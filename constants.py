...
LINE_COLOR = (25,32,59)
# Derived constants
MARGIN_TOP = CELL_SIZE*3
MARGIN_SIDE = CELL_SIZE*1
BOARD_SIZE = N * CELL_SIZE
WIDTH, HEIGHT = 2 * MARGIN_SIDE + BOARD_SIZE, MARGIN_TOP + BOARD_SIZE + 5 * CELL_SIZE
...
CORNER_BIG = [(-1,i) for i in range(0,-3,-1)] + [(i,0) for i in range(0,2)]
CORNER_BIG_R1 = [(-1,i) for i in range(0,-3,-1)] + [(i,-2) for i in range(0,2)]
...
SHAPES = (
    ...
    (L_SHAPE,L_SHAPE_R1,L_SHAPE_R2,L_SHAPE_R3,REV_L_SHAPE,REV_L_SHAPE_R1,REV_L_SHAPE_R2,REV_L_SHAPE_R3),
    (T_SHAPE,T_SHAPE_R1,T_SHAPE_R2,T_SHAPE_R3),
    (Z_SHAPE,Z_SHAPE_R1,REV_Z_SHAPE,REV_Z_SHAPE_R1),
    (SLASH_SHAPE,REV_SLASH_SHAPE),
)
